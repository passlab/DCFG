## looppoint pintool options (version 3.2)
~~~~
[yan@fornax simple_loop_dependency-pinplay]$ $PIN_ROOT/pin -follow_execv -t $PIN_ROOT/extras/dcfg/bin/intel64/looppoint.so -h -- ./simple_loop
This tool creates BBV profile based on   Dynamic Control Flow Graph (DCFG) of input pinball.
