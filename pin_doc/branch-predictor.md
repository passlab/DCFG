## branch-predictor pintool options
~~~~
[yan@fornax simple_loop_dependency-pinplay]$ $PIN_ROOT/pin -t $PIN_ROOT/extras/pinplay/bin/intel64/pinplay-branch-predictor.so -h -- ./simple_loop
...
-phaselen  [default 100000000]
	Print branch mispredict stats every these many instructions (and also
	at the end).

-statfile  [default bimodal.out]
	Name of the branch predictor stats file.
